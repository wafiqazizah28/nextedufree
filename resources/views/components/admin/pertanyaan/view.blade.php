...
@section('content')
  <div class="flex justify-between items-center mb-4">
    ...
    <button id="exportPDF" class="rounded-lg bg-purple-600 py-2.5 px-5 text-white hover:bg-red-700 transition-all duration-300 focus:ring-2 focus:ring-red-300 font-medium">
