      ...
      <div class="self-center lg:w-2/3">
        <div class="space-beetween flex">
          <h1 class="text-2xl font-bold text-primary lg:text-3xl">
            Add <span class="text-secondary">Pertanyaans</span>
          </h1>
          <button
        ...
        <form class="mt-5" method="post" action="/pertanyaans">
          @csrf
          <div class="w-full lg:mx-auto">
            <div class="mb-4 w-full px-4">
              ...
              <input type="text" id="pertanyaans_code" name="pertanyaans_code" value="{{ @old('pertanyaans_code') }}"
            ...
            <div class="mb-4 w-full px-4">
              ...
              <input type="text" id="pertanyaans " name="pertanyaans" value="{{ @old('pertanyaans') }}"
