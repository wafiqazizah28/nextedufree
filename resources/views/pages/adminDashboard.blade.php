...
<div class="flex min-h-screen">
        ...
        <aside class="w-1/5 bg-purpleMain border-2 border-purpleMain text-white shadow-lg flex flex-col items-center rounded-r-3xl overflow-hidden">
            ...
            <nav class="w-full px-6 py-6 flex-grow">
                ...
                <a href="/pertanyaan" class="flex items-center px-4 py-3 rounded-lg text-lg font-medium hover:bg-indigo-600 mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="/hasiltes" class="flex items-center px-4 py-3 rounded-lg text-lg font-medium hover:bg-indigo-600 mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="/saranpekerjaan" class="flex items-center px-4 py-3 rounded-lg text-lg font-medium hover:bg-indigo-600 mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                    </svg>
                    Saran Pekerjaan
                ...
                <a href="/sekolah" class="flex items-center px-4 py-3 rounded-lg text-lg font-medium hover:bg-indigo-600 mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                    </svg>
                    Setting Sekolah
                ...
                <a href="/testimoni" class="flex items-center px-4 py-3 rounded-lg text-lg font-medium hover:bg-indigo-600 mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                    </svg>
                    Settings Testimoni
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg">
                ...
                <section class="grid grid-cols-4 gap-4">
                    <div class="bg-white p-6 rounded-md shadow-md text-center">
                        <h2 class="text-4xl font-bold text-indigo-700">{{ count($pertanyaanInfo ?? []) }}</h2>
